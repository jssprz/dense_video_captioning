...
from model.embeddings.multilevel_enc import VisualMultiLevelEncoding, TextMultiLevelEncoding
...
class MultiModal(nn.Module):
    def __init__(self, v_enc_config, t_enc_config, out_size, vocab_size):
        ...
        self.v_model = VisualMultiLevelEncoding(cnn_feats_size=v_enc_config.cnn_feats_size, 
        ...
        self.t_model = TextMultiLevelEncoding(vocab_size=vocab_size,
                                              out_size=out_size,
